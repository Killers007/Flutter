...
import 'package:hello/pages/kumpulan_app/shoe/src/widgets/BottomNavigationBar/bottom_curved_Painter.dart';
...
class _CustomBottomNavigationBarState extends State<CustomBottomNavigationBar>
  ...
  void _handlePressed(int index) {
    ...
    Future.delayed(
      ...
      () {
        _yController.animateTo(1.0, duration: Duration(milliseconds: 10));
      },
    );
